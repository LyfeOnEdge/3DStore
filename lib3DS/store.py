# Some basic scripts for installing 3ds libget zips given the package name
...
class Store(object):
	...
	def getImage(self, package, image_type, force = False):
		...
		if os.path.isfile(image_file) and not force:
			...
			return self.download(self.image_base_url.format(package, image_type), image_file, silent = False)
